 ...
 * @author David
 */
@WebServlet(name = "CompaniasTableLoader", urlPatterns = {"/CompaniasTableLoader"})
public class CompaniasTableLoader extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("filtro") == null) {
            String data = dao.getCompForTable((String)request.getSession().getAttribute("filtros"));
